...
class Translator(object):
    ...
    def _translate_random_sampling(
        ...
        # Encoder forward.
        src, enc_states_final, memory_bank_final, memory_lengths_final, ans = self._run_encoder(batch)
        ...
        self.model.decoder.init_state(torch.cat([src, ans], 0), memory_bank_final, enc_states_final)
    ...
    def _run_encoder(self, batch):
        ...
        enc_states_final, memory_bank_final, memory_lengths_final = self.model.encoder_1( torch.cat([enc_states_ques, enc_states_ans], 0), memory_lengths_final, tot_final=True)
					
        return src, enc_states_final, memory_bank_final, memory_lengths_final, ans
